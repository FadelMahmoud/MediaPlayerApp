...
namespace MediaPlayer.ViewModel
{
    public class PlayerViewModel : BaseViewModel
    {
        ...
        private TimeSpan songReminderTime;
        public TimeSpan SongReminderTime
        {
            get { return songReminderTime; }
            set
            {
                songReminderTime = value;
                    OnPropertyChanged();
            }
        }
        ...
        private async void PlayMusic(Music music)
        {
            ...
            SongReminderTime = mediaInfo.Duration - Position;
